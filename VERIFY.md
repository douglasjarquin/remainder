...
This policy does not authorize provider collection, authentication, cache implementation, or any runtime dependency beyond the pinned Cobra and go-toon graph.
